// const getImport = document.getElementById('#navbar-file'); 
// // document.getElementById('contenedor').appendChild(getImport); 
// document.getElementById('contenedor').innerHTML = getImport;
let pagina = 1;
        ...
        if(respuesta.status === 200) {
            ...
            datos.results.forEach(pelicula => {
                ...
                <div class="pelicula" id=${pelicula.id}>
                    <a href="./pelicula-info.html?id=${pelicula.id}">
